...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      event_needs: {
        Row: {
          ...
          id: string
          is_active: boolean
          kind: Database["public"]["Enums"]["event_need_kind"]
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "event_needs_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      event_pledges: {
        Row: {
          ...
          profile_id: string | null
          quantity: number
          status: Database["public"]["Enums"]["event_pledge_status"]
          tenant_id: string
          updated_at: string
        }
        Insert: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "event_pledges_need_id_fkey"
            columns: ["need_id"]
            isOneToOne: false
          ...
          {
            foreignKeyName: "event_pledges_profile_id_fkey"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "event_pledges_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      event_raised_amount: { Args: { _event_id: string }; Returns: number }
    ...
    Enums: {
      ...
      event_need_kind: "sponsorship" | "item"
      event_pledge_status: "promised" | "fulfilled" | "cancelled"
